...
Credits for this code goes to [conchylucultor](https://github.com/Conchylicultor/DeepQA). I've merely created a wrapper to get people started. For specific code for our Project Eve, clicks [here](https://github.com/oscarscaro/EVE). If you want to know more about Eve or collaboration, please contact oscarfantasywork@outlook.com
